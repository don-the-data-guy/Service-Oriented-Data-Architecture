/**
*** The Scala program you linked to is part of the "Overwatch" project by Databricks, which provides a framework for building scalable, 
*** maintainable, and modular data pipelines using Apache Spark. More specifically, the BronzeTransforms.scala file contains a set of functions 
*** for transforming raw, "bronze" data into a more refined format.
*** 
...
*** These functions typically take a DataFrame (i.e., a distributed collection of data) as input and return a new DataFrame 
*** that has been modified in some way. Here are some of the key functions defined in this file:
*** - addMetadata: This function adds metadata to a DataFrame, including information about the source of the data, the timestamp of when it was ingested,
...
*** - transformUsageData: This function applies a set of transformations to usage data (i.e., data that describes how a particular resource is being used)
***   in order to clean and reformat it.
*** - transformWeblogs: This function applies a similar set of transformations to web log data (i.e., data that describes website traffic). 
***   in order to extract key information and prepare it for further analysis.
*** - transformUsageData: This function applies a set of transformations to usage data (i.e., data that describes how a particular resource is being used)
***   in order to clean and reformat it.
